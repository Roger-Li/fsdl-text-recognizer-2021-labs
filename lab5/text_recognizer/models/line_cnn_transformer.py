...
class LineCNNTransformer(nn.Module):
    ...
    def __init__(
        ...
        inverse_mapping = {val: ind for ind,
                           val in enumerate(data_config["mapping"])}
        ...
        self.line_cnn = LineCNN(
            data_config=data_config_for_line_cnn, args=args)
    ...
    def decode(self, x, y):
        ...
        # Cross-attention between the last layer of embedder and the embedding of the decoder
        # Check out https://pytorch.org/docs/stable/generated/torch.nn.TransformerDecoder.html
        # and https://pytorch.org/docs/stable/generated/torch.nn.TransformerDecoderLayer.html
    ...
    def predict(self, x: torch.Tensor) -> torch.Tensor:
        ...
        output_tokens = (torch.ones((B, S)) *
                         self.padding_token).type_as(x).long()  # (B, S)
